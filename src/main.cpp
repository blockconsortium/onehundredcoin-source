...
#if defined(NDEBUG)
# error "OneHundredCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OneHundredCoin Signed Message:\n";
...
{
    RenameThread("onehundredcoin-loadblk");
